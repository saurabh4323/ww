      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex-shrink-0 flex items-center">
            ...
            <div>
              <h1 className="text-2xl font-bold text-white tracking-wider">SENADRIVE</h1>
              <p className="text-orange-300 text-xs font-medium">Indian Army Portal</p>
            </div>
          </div>
...
export default function Login() {
  ...
  const handleForgotPassword = async () => {
    ...
    try {
      ...
      setSubmitMessage({
        type: "success",
        message: "Password reset instructions sent to your registered mobile number and email.",
      });
      setShowForgotPassword(false);
    } catch (error) {
      setSubmitMessage({
        type: "error",
        message: "Unable to send reset instructions. Please contact IT support.",
      });
    } finally {
      setIsSubmitting(false);
    }
        ...
        <div className="container mx-auto px-4 py-12 relative z-10">
          ...
          <div className="text-center mb-12">
            <div className="flex justify-center items-center mb-6">
              ...
              <div>
                <h1 className="text-5xl font-bold text-white tracking-wider">SENADRIVE</h1>
                <p className="text-orange-300 font-semibold text-lg">Indian Army Personnel Portal</p>
              </div>
            </div>
            <div className="flex justify-center space-x-8 text-sm text-blue-200">
              <span className="flex items-center"><span className="text-orange-400 mr-1">🇮🇳</span> Service Before Self</span>
              <span className="flex items-center"><span className="text-green-400 mr-1">⚔️</span> Honor & Duty</span>
              <span className="flex items-center"><span className="text-white mr-1">🛡️</span> Nation First</span>
            </div>
          </div>
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl border border-white/20 overflow-hidden">
              ...
              <div className="p-8">
                ...
                <div className="space-y-6">
                  {/* Service ID */}
                  <div>
                    <label htmlFor="ServiceId" className="block text-sm font-semibold text-white mb-2">
                    ...
                    />
                    {errors.ServiceId && (
                      <p className="mt-2 text-sm text-red-300">{errors.ServiceId}</p>
                    )}
                  </div>
                  ...
                  {showForgotPassword && (
                    <div className="bg-blue-900/30 p-4 rounded-lg border border-blue-400/30">
                      ...
                      <p className="text-white/80 text-sm mb-3">
                        Enter your Service ID and we'll send reset instructions to your registered contact details.
                      </p>
